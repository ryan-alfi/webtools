                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="bootstrap-admin-panel-content">
                                    <table class="table table-striped table-bordered" id="example">
                                        ...
                                        <tbody>
                                            <?php
                                                $data = mysql_query('SELECT * FROM tmentahan where status=0');
                                                while($key = mysql_fetch_assoc($data)) {
                                        ?>
                                                <tr>
                                                    <td><?php echo $key["judul"] ?></td>
                                                    <td><?php echo $key["kategori"] ?></td>
                                                    <td><a class="btn btn-success" href="split.php?id=<?php echo $key["id"] ?>">Pick</a></td>
                                                </tr>
                                        <?php
                                                }
                                            ?> 
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="bootstrap-admin-panel-content">
                                    <table class="table table-striped table-bordered" id="example">
                                        ...
                                        <tbody>
                                            <?php
                                                $data = mysql_query("SELECT * FROM tmentahan m, tlog l where l.id = m.id and m.status=4 and l.email= '".$user."'");
                                                while($key = mysql_fetch_assoc($data)) {
                                        ?>
                                                <tr>
                                                    <td><?php echo $key["judul"] ?></td>
                                                    <td><?php echo $key["kategori"] ?></td>
                                                    <td><a class="btn btn-success" href="restore.php?id=<?php echo $key["id"] ?>">Pick</a></td>
                                                </tr>
                                        <?php
                                                }
                                            ?> 
